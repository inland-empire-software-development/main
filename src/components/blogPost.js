...
const blogPost = (props) => {
  const imageURL = props.postData.featured_media ? props.postData._embedded["wp:featuredmedia"][0].source_url : "";

  return (
    <div className = "blog-preview">
      <div className = "blog-preview-header">
        <img src = {imageURL} className = "blog-preview-image" />
        <div className = "blog-preview-category">{props.postData.categories[0]}</div>
      </div>
