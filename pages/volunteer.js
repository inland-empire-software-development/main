        ...
        <div className="uk-column-1-2@m">
          <div>
            <p className="body-content">
              ...
              If you know anyone outside of IESD who may be interested, share this list with them. We can use all the help we can get.
            </p>
            <p className="body-content">Benefits include:</p>
            <ul>
